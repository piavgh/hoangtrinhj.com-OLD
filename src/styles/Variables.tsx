...
export const $xSmall = '720px'
export const $small = '800px'
export const $medium = '1200px'
export const $large = '1300px'

/* Breakpoints */
export const $mobile = '620px'
export const $tablet = $small
export const $desktop = $medium
