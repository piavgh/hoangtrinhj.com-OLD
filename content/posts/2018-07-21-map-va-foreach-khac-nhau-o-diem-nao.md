...
> Điểm khác biệt lớn nhất là forEach() không trả về giá trị nào cả. Nó chỉ đơn giản là thực hiện hàm callback lên từng phẩn tử ở trong mảng. Một khác biệt nhỏ nữa so với phương thức map() là những hàm callback này có thể thay đổi trực tiếp mảng ban đầu.
...
Câu trả lời là tùy từng trường hợp. Nếu bạn không quan tâm tới các giá trị trả về và cũng không quá quan tâm đến performance (có thể vì cái hàm rất bé) thì chỉ cần dùng `.forEach` là đủ rồi
